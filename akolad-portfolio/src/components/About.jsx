...
const ServicesCard = ({index, title, icon}) => {
  return (
    <motion.div
      ...
      className=" w-full xs:w-[250px] rounded-[20px] rounded-tl-[200px] green-pink-gradient p-[1px] shadow-card"
    >
      <Tilt
        glareEnable={true}
        tiltMaxAngleX={20}
...
const About = () => {
  return (
    <>
      ...
      <div className="mt-20 flex flex-wrap justify-center content-center gap-10 me-3">
...
const sectionWrapper = SectionWrapper(About, "about");
